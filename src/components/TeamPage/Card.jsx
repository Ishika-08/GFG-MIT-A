  ...
  return (
    <div className="flex flex-col items-center justify-between border-with-shadow p-4">
      ...
      <div className="mx-auto">
        <img
          className="w-60 h-[240px] rounded-2xl drop-shadow-md hover:drop-shadow-xl transition-all duration-200 delay-100"
          src={ele.photourl}
        />
      </div>
      {/* Details */}
      <div className="text-center mt-6">
        {/* Name */}
        <h1 className="text-slate-200 text-lg font-bold mb-1">{ele.name}</h1>
        {/* Title */}
