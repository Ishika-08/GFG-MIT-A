          ...
          <div className="w-full lg:w-1/3 m-auto mt-12 max-w-screen-sm light-background-for-event-cards">
            <div className="p-4 ">
              <div className="flex py-2">
                <div>
                  <p className="font-semibold text-gray-700 text-sm">End at</p>
              ...
              <button className="px-2 py-1 mt-8 text-zinc-800 bg-red-600 flex w-full items-center justify-center rounded">
                Closed
              </button>
            </div>
          </div>
